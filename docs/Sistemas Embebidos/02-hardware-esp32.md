...
## Ecosistema Arduino (ej. Arduino UNO)
*(Escribe un párrafo indicando que es ideal para educación y prototipos rápidos, pero que su microcontrolador básico y la falta de conectividad nativa lo limitan en entornos de producción modernos).*
