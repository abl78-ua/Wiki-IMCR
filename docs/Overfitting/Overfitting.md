...
Para evaluar completamente la efectividad de un modelo, debes examinar la precisión y la recuperación. Normalmente, una mejora de la precisión suele reducir la recuperación, y viceversa. Para entender estos conceptos, vamos a explicar más detalladamente que son la precisión y la recuperación.
...
La recuperación es 60 de 100, un 60%. [10]


Por último, vamos a hacer otro ejemplo, uno donde se ilustre mejor la tensión que hay entre la precisión y la recuperación, pudiendo observar más fácilmente como una disminuye si la otra mejora y viceversa.
...
Vamos a calcular la precisión y recuperación como ya hemos hecho en el ejemplo anterior.
...
Y la recuperación mide el porcentaje de correos reales que se clasificaron correctamente, es decir, el porcentaje de puntos a la izquierda del umbral que aparecen en verde.
...
En este caso obtenemos una precisión de 0.88 y 0.64

Por último, vamos a mostrar que ocurre si disminuimos el umbral.


Y en este caso la precisión pasa a ser 0.75 y el recall a 0.82.  [11]
...
[6]
https://link.springer.com/article/10.1007/s10270-008-0106-z
[7]
https://es.wikipedia.org/wiki/Precisi%C3%B3n_y_exhaustividad 
[8]
https://es.wikipedia.org/wiki/Gerard_Salton 
[9]
...
[12]
https://www.v7labs.com/blog/f1-score-guide#:~:text=The%20F1%20score%20is%20calculated,simple%20arithmetic%20or%20geometric%20means%3F
[13]
https://www.cienciasinseso.com/f1_score/ 
[14]
